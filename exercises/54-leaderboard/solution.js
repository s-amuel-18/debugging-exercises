...
class Leaderboard {
  ...
  // CORREGIDO: retorna el puntaje máximo del jugador, no el primero.
  // El bug usaba scores[0] (primer envío) en lugar de Math.max(...scores),
  // haciendo que mejorar el puntaje no tuviera efecto en el ranking.
...
if (require.main === module) {
  ...
  board.addScore('Carol', 80);
  board.addScore('Dave', 60);

  console.log('Alice best:', board.getPlayerBest('Alice')); // 90
  console.log('Ranking:', board.getRanking());
  console.log('Top 2:', board.getTopN(2));
  console.log('Tied with Bob:', board.getTiedPlayers('Bob'));
  console.log('Average:', board.getAverageScore());
}
